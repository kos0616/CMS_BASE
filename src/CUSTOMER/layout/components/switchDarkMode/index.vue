<template>
  <label class="relative inline-flex cursor-pointer items-center fill-current">
    <input
      v-model="theme"
      type="checkbox"
      class="peer sr-only"
...
import useSwitchDarkmode from '@/CORE/API/useSwitchDarkmode'
